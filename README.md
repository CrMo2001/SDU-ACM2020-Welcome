...
为了加深对语言的学习，推荐[洛谷题单](https://www.luogu.com.cn/training/list)，里面有各种难度的训练习题。

如果您已经完成了语言的学习，并且有能力完成新手村的内容，请继续阅读算法竞赛入门经典的后续章节，并继续完成洛谷题单（普及/提高）的其他内容。
...
首先，建议自行康复，然后学一下java和python。
其次，建议打比赛，CF，AtCoder，等等。
最后，建议刷题，请务必在新生赛上大秀一波（如果有机会的话）。

## 3 结束
有啥想进一步了解的可以私聊19-计科-师浩晏或在群里问。
